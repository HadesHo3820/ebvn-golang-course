...
func (_m *User) CreateUser(ctx context.Context, newUser *model.User) (*model.User, error) {
...
func (_m *User) UpdateUser(ctx context.Context, userID string, displayName string, email string) error {
