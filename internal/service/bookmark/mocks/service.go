...
import (
	...
	dto "github.com/HadesHo3820/ebvn-golang-course/internal/dto"
...
func (_m *Service) GetBookmarks(ctx context.Context, userID string, req *dto.Request) (*dto.Response[*model.Bookmark], error) {
	...
	var r0 *dto.Response[*model.Bookmark]
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *dto.Request) (*dto.Response[*model.Bookmark], error)); ok {
		return rf(ctx, userID, req)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, *dto.Request) *dto.Response[*model.Bookmark]); ok {
		r0 = rf(ctx, userID, req)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*dto.Response[*model.Bookmark])
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, *dto.Request) error); ok {
